                    ...
                    <div className="col-md-6">
                        ...
                        <form className="mt-5">
                            <div className="form-group text-start">
                                ...
                                <input type="email" className="form-control mb-0" placeholder="Your Full Name" value="marvin" />
                            </div>
                            <div className="form-group text-start">
                            ...
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                <a href="pages-recoverpw.html" className="font-italic">Forgot Password?</a>
                            </div>
                            <a type="button" className="btn btn-primary mt-4 fw-semibold text-uppercase w-100" href="../index.html">sign in</a>
                            <h6 className="mt-5">Don't Have An Account ? <Link to="/account/signup">Sign Up</Link></h6>
                        </form>
                        </div>
                    </div>
                </div>
