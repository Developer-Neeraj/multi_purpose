                    ...
                    <div className="row align-items-center">
                        <div className="col-md-6 overflow-hidden position-relative">
                            ...
                            <div className="sign-in-detail container-inside-top">
                                <div className="swiper swiper-general overflow-hidden " data-slide="1" data-laptop="1" data-tab="1" data-mobile="1"
                                    data-mobile-sm="1" data-autoplay="true" data-loop="true" data-navigation="false" data-pagination="true"
                                    data-space="16">
                                    <ul  className="swiper-wrapper list-inline m-0 p-0 ">
                                        <li className="swiper-slide">
                                            <img src="/assets/images/login/1.jpg" className="signin-img img-fluid mb-5 rounded-3" alt="image" />
                                            <h2 className="mb-3 text-white fw-semibold">Power UP Your Friendship</h2>
                                            <p className="font-size-16 text-white mb-0">It is a long established fact that a reader will be<br/> distracted by the readable content.</p>
                                        </li>
                                        <li className="swiper-slide">
                                            <img src="/assets/images/login/2.jpg" className="signin-img img-fluid mb-5 rounded-3" alt="image" /> 
                                            <h2 className="mb-3 text-white fw-semibold">Connect with the world</h2>
                                            <p className="font-size-16 text-white mb-0">It is a long established fact that a reader will be<br/> distracted by the readable content.</p>
                                        </li>
                                        <li className="swiper-slide">
                                            <img src="/assets/images/login/3.jpg" className="signin-img img-fluid mb-5 rounded-3" alt="image" />
                                            <h2 className="mb-3 text-white fw-semibold">Together Is better</h2>
                                            <p className="font-size-16 text-white mb-0">It is a long established fact that a reader will be<br/> distracted by the readable content.</p>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div className="col-md-6">
                            ...
                            <a href="../index.html"
                                ...
                                <h2 className="logo-title" data-setting="app_name">SocialV</h2>
                            </a>
                            <p className="mt-3 font-size-16">Welcome to socialV, a platform to connect with<br /> the social world</p>
                            <form className="mt-5">
                                <div className="form-group text-start">
                                    <h6 className="form-label fw-bold">Your Full Name</h6>
                                    <input type="text" className="form-control mb-0" placeholder="Your Full Name" value="marvin shaw" />
                                </div>
                                <div className="form-group text-start">
                                    <h6 className="form-label fw-bold">Email Address</h6>
                                    <input type="email" className="form-control mb-0" placeholder="Your Full Name" value="marvin@example.com" />
                                </div>
                                <div className="form-group text-start">
                                    <h6 className="form-label fw-bold">Your Password</h6>
                                    <input type="password" className="form-control mb-0" placeholder="Password" value="marvin" />
                                </div>
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="form-check d-inline-block m-0">
                                        <input type="checkbox" className="form-check-input" />
                                        <h6 className="form-check-label fw-500 font-size-14">I accept <a className="fw-light ms-1">Terms and Conditions</a></h6>
                                    </div>
                                </div>
                                <button type="button" className="btn btn-primary mt-4 fw-semibold text-uppercase w-100">sign up</button>
                                <h6 className="mt-5">Already Have An Account ? <Link to="/account/login">Login</Link></h6>
                            </form>
                            </div>
                        </div>
                    </div>
